...
const PROJECTS = [
  {
    name: 'Falling Fruit',
    date: '03/2021',
    desc: "A progressive web application built for foraging non-profit 'Falling Fruit' with a shared codebase for web and mobile applications.",
  ...
  },
  {
    ...
    date: '02/2021',
    desc: 'A startup directory built by Founders for the University of Illinois at Urbana-Champaign.',
  ...
  },
  {
    ...
    date: '08/2019',
    desc: 'Super Mario Maker 2 level idea generator over 35,000+ users. Generates game ideas with three compatible enemies, a time, a theme and a twist.',
    tags: ['JavaScript'],
