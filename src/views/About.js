        ...
        return (
            <main>
                ...
                <article className="case row">
                    <img src="/images/about.jpg" alt="headshot" className="columns four" style={{margin: "0 auto"}} />
                        <div className="columns eight" id="about-page-bio">
                            <p>
                                ...
                                Hack4Impact<i style={{fontSize: "1rem", marginLeft: "5px"}} className="fas fa-external-link-alt" /></a> .
                                <br /><br />
