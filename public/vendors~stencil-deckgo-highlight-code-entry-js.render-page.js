...
/* harmony import */ var _index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index-d659bdc0.js */ "./node_modules/@deckdeckgo/highlight-code/dist/esm-es5/index-d659bdc0.js");
...
const DeckdeckgoHighlightCode = class {
    constructor(hostRef) {
        ...
        this.prismLanguageLoaded = Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "prismLanguageLoaded", 7);
        this.codeDidChange = Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "codeDidChange", 7);
    }
    ...
    render() {
        return (Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["H"], { class: {
            ...
            } }, this.renderCarbon(), this.renderUbuntu(), Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "deckgo-highlight-code-container", onMouseDown: () => this.edit(), onTouchStart: () => this.edit() }, Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("code", null), Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "code" }))));
    }
    renderCarbon() {
        if (this.terminal !== 'carbon') {
            return undefined;
        }
        return (Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green')));
    }
    renderCarbonCircle(color) {
        return Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: color });
    }
    renderUbuntu() {
        if (this.terminal !== 'ubuntu') {
            return undefined;
        }
        return (Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "ubuntu" }, this.renderUbuntuCircle('close'), this.renderUbuntuCircle('minimize'), this.renderUbuntuCircle('maximize'), Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("p", null, Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", { name: "user" }))));
    }
    renderUbuntuCircle(mode) {
        const symbol = mode === 'close' ? '&#10005;' : mode === 'minimize' ? '&#9472;' : '&#9723;';
        return Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: mode, innerHTML: symbol });
    }
    get el() { return Object(_index_d659bdc0_js__WEBPACK_IMPORTED_MODULE_0__["g"])(this); }
